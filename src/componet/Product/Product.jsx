...
function Product({ product }) {
    ...
    return (
        <div id='product' className={style.contentCard}>
            {/* <FormOrder/> */}
            {product.length === 0 ? (
                ...
                <div className={style.ReadProductDetail}>
                    <div className={style.popup}>
                        <div className={style.top}>
                            <span onClick={() => `${setValuePopUpRead("0")} ${hendleClose()}`} className="material-symbols-outlined">close</span>
                            {/* <i onClick={() => setValuePopUpRead("0")} className="fa-regular fa-circle-xmark"></i> */}
                        </div>
                        <div className={style.content}>
                            <div className={style.image}>
                                <img src={dataImageClick == false ? dataById?.product_images[0]?.url_image : dataImageClick} alt="" />
                            ...
                            <div className={style.detail}>
                                ...
                                <span className={style.deskripsi}><p className={style.subData}>Deskripsi</p>{dataById?.Deskripsi_produk}</span>
                                        ...
                                        return (
                                            <div key={key} className={style.itemReview}>
                                                ...
                                                <div className={style.dataReview}>
                                                    ...
                                                    <span>{new Date(data.created_at).getDate() + " - " + bulan[new Date(data.created_at).getMonth() ]+ " - " + new Date(data.created_at).getFullYear()}</span>
