                                    ...
                                    <div key={key} className={style.content}>
                                        ...
                                        <div className={style.contentCenter}>
                                            <div className={style.contentCenterItem}>
                                                ...
                                                <span className={style.subData}>Kategori : {data?.products.categories.name}</span></span>
                                                <span>Jumlah : {data.jumlah}</span>
                                                <span>Deskripsi Produk : {data.products.Deskripsi_produk}</span>
                                            </div>
                                            <div className={style.contentCenterItem}>
                                                <span className={style.cardHarga}>{new Intl.NumberFormat("id-ID", {style: "currency", currency: "IDR"}).format(data.Price)}</span>
                                                <div className={style.average} >
                                                   <div>
                                                        <input id={`${data.id} trima`} type="checkbox" checked={data.status == 2 ? true : false}  onChange={(e) => hendleStatusPesanan(data.id, 2, e)}/>
                                                        <label htmlFor={`${data.id} trima`}>Pesanan diterima</label>
                                                   </div>
                                                   <div>
                                                        <input id={`${data.id} tolak`} type="checkbox" checked={data.status == 1 ? true: false} onChange={(e) => hendleStatusPesanan(data.id, 1, e)}/>
