...
function PersediaanBahanBaku() {
  ...
  const [namaSatuanPersediaanBahanBaku, setNamaSatuanPersediaanBahanBaku] =
    useState();
  ...
  const hendleGetAllBahanBaku = () => {
    axios
      .get(`${process.env.REACT_APP_BASE_API}/bahanBaku`, {
        headers: { Authorization: `Bearer ${dataLogin.dataLogin.token}` },
      })
      .then((res) => {
        console.log(res.data.data);
  ...
  const sumbitPersediaanBahanBaku = () => {
    ...
    if (popup == "Tambah") {
      axios
        .post(`${process.env.REACT_APP_BASE_API}/persediaanBahanBaku`, data, {
          headers: { Authorization: `Bearer ${dataLogin.dataLogin.token}` },
        })
        .then((res) => {
          console.log(res.data.data);
      ...
      axios
        .patch(
          `${process.env.REACT_APP_BASE_API}/persediaanBahanBaku/${idPersediaanBahanBaku}`,
          data,
          { headers: { Authorization: `Bearer ${dataLogin.dataLogin.token}` } },
        )
        .then((res) => {
  ...
  const hendleDeleteBahanBaku = (iddelete) => {
    axios
      .delete(
        `${process.env.REACT_APP_BASE_API}/persediaanBahanBaku/${iddelete}`,
        {
          headers: { Authorization: `Bearer ${dataLogin.dataLogin.token}` },
        },
      )
                      ...
                      <td className={style.options}>
                        <span
                          ...
                          onClick={() =>
                            `${setPopup(
                              "Edit",
                            )} ${hendleGetByIdPersediaanBahanBakuForEdit(
                              data.id,
                            )}`
                          }>
                          edit
                        ...
                        <span
                          className={`material-symbols-outlined ${style.iconOptions}`}
                          onClick={() => hendleDeleteBahanBaku(data.id)}>
                          delete
                        </span>
                      </td>
                    </tr>
            ...
            <div className={style.contentPopUpBahanBaku}>
              <div className={style.top}>
                ...
                <span
                  ...
                  onClick={() => `${setPopup(false)} ${hendleClose()}`}>
                  close
                </span>
              </div>
